...
function load_child_page(child) {
    ...
    $.ajax({
        ...
        success: function (res) {
            ...
            load_on_child_success(res, child);
...
function load_on_child_success(res, child) {
    /*custom*/
}
...
function show_child_page(child) {
    ...
    for (var i = start; i <= limit; i++) {
        ...
        else html += '<li><a href="javascript:;" onclick="get_child_page(' + i + ",'" + child + '\')">' + i + '</a></li>';
    }
