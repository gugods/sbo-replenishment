...
$dir = $_SERVER['DOCUMENT_ROOT'] . '/sbo-replenishment/admin/files/' . time() . "_" . $_FILES['upload']['name'];
$url = "http://" . $_SERVER['HTTP_HOST'] . '/sbo-replenishment/admin/files/' . time() . "_" . $_FILES['upload']['name'];
