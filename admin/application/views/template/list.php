        ...
        <div class="x_panel">
          <div class="x_title">
            ...
            <div class="pull-right">
              <button ng-if="ref_back!='' && ref_back!=undefined && ref_back!==null" ng-click="setRefresh(ref_back)" type="button" class="btn btn-dark btn-back">
          ...
          <div class="x_content">
            ...
            <div id="boxSearch">
              <form name="formSearch" id="formSearch" method="post" action="{{module}}" class="form-horizontal" role="form" ref="{{module}}/ajaxList">
                ...
                <button type="button" ng-click="setRefresh(module+ '?search=reset')" class="btn btn-default btn-refresh"><span class="glyphicon glyphicon-refresh"></span> Refresh</button>
            ...
            <div class="row">
              <div class="col-md-8 col-xs-8">Pages
                ...
                <?php if (file_exists(APPPATH . 'modules/backend/' . $module . '/views/import_example_custom.php')) { ?>
                  <?php $this->load->view($module . '/import_example_custom.php'); ?>
                <?php } else { ?>
                  ...
                  <tbody>
                    <tr ng-repeat="item in items">
                      ...
                      <td ng-if="control_mode!='OFF'" class="center">
                        <a ng-if="edit_mode!='OFF' && sys_action!='delete'" href="{{module}}/formEdit/{{getObj(item,module+'_id')}}" class="glyphicon glyphicon-pencil btn-edit" data-toggle="tooltip" title="click to edit"></a>
                        ...
                        <a ng-if="display_mode!='OFF' && sys_action!='delete'" href="{{module}}/formDisplay/{{getObj(item,module+'_id')}}" class="glyphicon glyphicon-eye-open btn-display" data-toggle="tooltip" title="click to display"></a>
