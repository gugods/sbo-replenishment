  ...
  function search_parent(nestList, parent_id) {
    ...
    $.each(nestList, function(key, item) {
      if (parent_id == item.parent_id) {
        ...
        dd_html += '<div class="dd-handle dd3-handle"></div>';
        ...
        for (var i in app_list.column) {
          ...
          if (col.type == 'image') {
            dd_html += ' | <img src="upload/' + app_child + '/thumb_list/' + getObj(item, col.name) + '" width="62"  onerror="this.onerror=null;this.src=\'themes/admin/assets/images/no-image.png\';" class="img-preview-child" />';
