		...
		<div class="col-md-12 col-xs-12">
			<div class="x_content">
				<div class="row">
					<div class="col-md-5">
						<div ng-if="totalpage>1" class="row">
							<div class="col-md-12">
								<ul class="pagination pagination_{{child}}" style="margin:0px;">
					...
					<div class="col-md-7 control pull-right">
						<div class="btn-group">
				...
				<div class="table-responsive" style="margin: auto;">
							...
							<tbody>
								<tr ng-repeat="item in items">
									...
									<td ng-repeat="col in column" width="{{col.width}}" class="{{col.class}}">
										<div ng-if="col.type=='image'" class="image"><img ng-if="getObj(item,col.name)" ng-src="upload/{{col.filepath ? col.filepath : child}}/thumb_list/{{getObj(item,col.name)}}" width="62" onerror="this.onerror=null;this.src='themes/admin/assets/images/no-image.png';" class="img-preview-child" /></div>
										<div ng-if="col.type=='file'"><a ng-if="getObj(item,col.name)" ng-href="upload/{{col.filepath ? col.filepath : child}}/{{getObj(item,col.name)}}" target="_blank">Download</a></div>
					...
					<div ng-if="rows==0" class="col-md-12 col-xs-12 not_found" style="height: 30px;">- ไม่พบข้อมูล -</div>
				</div>
				<div ng-if="totalpage>1" class="row">
					<div class="col-md-12">
