              ...
              <div ng-if="action=='add' || action=='edit'" class="form-group">
                <div class="col-sm-offset-2 col-sm-10">
                  <div class="btn-group">
                    ...
                    <button ng-if="action=='add' && publish_mode=='OFF'" rel="{{id}}" type="button" class="btn btn-dark btn-save-list"><span class="glyphicon glyphicon-floppy-save"></span> Save</button>
