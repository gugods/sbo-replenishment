...
<div class="table-responsive">
	<table class="table table-hover table-striped table-bordered jambo_table bulk_action">
		<thead>
			<tr>
				<th width="10%">
					<div class="btn-sort" sorting="sys_action">Action</div>
				</th>
				<th width="20%">
					<div class="btn-sort" sorting="lastupdate">Date&amp;Time</div>
				</th>
				<th>
					<div>Message</div>
				</th>
				<th width="15%">
					<div class="btn-sort" sorting="update_name">By</div>
				</th>
			</tr>
		</thead>
		<tbody>
...
<input type="hidden" name="sorting" id="sorting" value="lastupdate" />
