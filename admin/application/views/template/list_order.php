    ...
    $.each(nestList, function(key, item) {
      if (parent_id == item.parent_id) {
        ...
        for (var i in app_list.column) {
          ...
          if (col.type == 'image') {
            dd_html += ' | <img src="upload/' + app_module + '/thumb_list/' + getObj(item, col.name) + '" width="62"  onerror="this.onerror=null;this.src=\'themes/admin/assets/images/no-image.png\';" class="img-preview" />';
