        ...
        <div class="x_panel">
          <div class="x_title">
            ...
            <div class="pull-right">
              ...
              <button ng-if="action!='update'" ng-click="setRefresh(module+'/formList/'+refid)" type="button" class="btn btn-dark btn-back">
                <span class="glyphicon glyphicon-chevron-left"></span> Back to list
              </button>
            </div>
            <div class="clearfix"></div>
          ...
          <div class="x_content">
            <form id="myForm" name="myForm" ng-action="{{module}}/" class="form-data form-horizontal form_{{action}}" role="form" method="post" enctype="multipart/form-data" ref="{{module}}/changeLog">
              ...
              <div ng-if="action=='display' && edit_mode!='OFF'" class="form-group">
                <div class="col-sm-offset-2 col-sm-10">
                  <div class="btn-group">
                    <button ng-click="setRefresh(module+'/formEdit/'+refid+'/'+id)" type="button" class="btn btn-dark btn-edit"><span class="glyphicon glyphicon-pencil"></span> Edit</button>
                  </div>
                </div>
              </div>
