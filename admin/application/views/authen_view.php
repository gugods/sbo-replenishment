      ...
      <div class="row">
        <div class="col-md-12">
          <div class="jumbotron">
            ...
            <p>Sb<sup>o</sup> Admin Management System.</p>
    ...
    <div class="animate form login_form x_panel">
      <section class="login_content">
        <form id="formLogin" action="authen/login" method="post" class="form-horizontal">
          <h5 class="heading" style="font-size: 26px;"><img src="themes/admin/assets/images/logo.png" style="width: 50px;margin-top: -6px;" />
            <i class="fa fa-recycle"></i> Replenishment
          </h5>
          <div class="progress">
            <div class="progress-bar" role="progressbar" aria-valuenow="40" aria-valuemin="0" aria-valuemax="100" style="width: 40%;background: #394d5f;">
              <span class="sr-only">40% Complete</span>
            </div>
          </div>
          <h2><img src="themes/admin/assets/images/lock.png"> Please sign in</h2>
          <div class="form-group">
            <div class="col-md-12 text-danger"><?php echo $this->session->flashdata('error_login'); ?></div>
          </div>
          <div class="form-group">
