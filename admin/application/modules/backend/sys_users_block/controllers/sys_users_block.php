...
class Sys_users_block extends Backend
{
	...
	function formList()
	{
		...
		$post = get_post_session('sys_users_block', $post);
		...
		parent::$view_data["sorting"] = isset($post['sorting']) ? $post['sorting']  : 'sys_users_block_id';
	...
	function ajaxList()
	{
		...
		if ($post) {
			set_post_session('sys_users_block', $post);
	...
	function searchList()
	{
		...
		if ($post) {
			...
			$rows = $this->sys_users_block_model->get_rows($post);
			$rows_publish = $this->sys_users_block_model->get_rows_publish($post);
			$rows_modified = $this->sys_users_block_model->get_rows_modified($post);
			$rows_unpublish = $this->sys_users_block_model->get_rows_unpublish($post);
